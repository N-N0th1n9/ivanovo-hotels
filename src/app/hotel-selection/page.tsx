...
export const metadata: Metadata = {
  title: 'Hotels',
  description: 'Страница с выбора одного из ивановских отелей: Ивановоотель и Артотель. Лучшие отели Иваново',
  keywords: ['Ивановоотель', 'Артотель', 'Ivanovootel', 'Artotel', 'Ивановские отели', 'Отели Иваново', 'Хорошие отели', 'Отличные отели']
}
